...
class ZeoStatusTrait(RoborockBase, TraitUpdateListener):
    ...
    doorlock_state: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.DOORLOCK_STATE})
    times_after_clean: int | None = field(default=None, metadata={"dps": RoborockZeoProtocol.TIMES_AFTER_CLEAN})
    app_authorization: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.APP_AUTHORIZATION})
    ...
    detergent_empty: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.DETERGENT_EMPTY})
    softener_empty: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.SOFTENER_EMPTY})

    # Dryer-specific status (None on washers).
    total_time: int | None = field(default=None, metadata={"dps": RoborockZeoProtocol.TOTAL_TIME})
    cloth_put_in: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.CLOTH_PUT_IN})
    ...
    smart_hosting_time: int | None = field(default=None, metadata={"dps": RoborockZeoProtocol.SMART_HOSTING_TIME})
    smart_hosting_waited_time: int | None = field(
        default=None, metadata={"dps": RoborockZeoProtocol.SMART_HOSTING_WAITED_TIME}
    )
    is_need_fluff_clean: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.IS_NEED_FLUFF_CLEAN})
    ...
    steam_care_time: int | None = field(default=None, metadata={"dps": RoborockZeoProtocol.STEAM_CARE_TIME})
    device_bound: bool | None = field(default=None, metadata={"dps": RoborockZeoProtocol.DEVICE_BOUND})

    # Meta — device-reported JSON documents (read-only).
    product_info: dict[str, Any] | None = field(default=None, metadata={"dps": RoborockZeoProtocol.PRODUCT_INFO})
    washing_log: ZeoWashLog | None = field(default=None, metadata={"dps": RoborockZeoProtocol.WASHING_LOG})
